...
<report name="practica50" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="PRACTICA50" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    ...
    <dataSource name="Q_1">
      ...
      <displayInfo x="1.03125" y="0.57300" width="3.42700" height="2.96875"/>
      <group name="G_CODIGO">
        <displayInfo x="2.09656" y="4.02087" width="1.27551" height="1.11426"
        />
        <dataItem name="TELEFONO" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="110000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Telefono">
          <dataDescriptor expression="HOSPITAL.TELEFONO"
           descriptiveExpression="TELEFONO" order="2" width="22" precision="9"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NOMBRE" datatype="vchar2" columnOrder="13" width="12"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nombre">
          <dataDescriptor expression="HOSPITAL.NOMBRE"
           descriptiveExpression="NOMBRE" order="3" width="12"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NUMCAMAS" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="60000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Numcamas">
          <dataDescriptor expression="HOSPITAL.NUMCAMAS"
           descriptiveExpression="NUMCAMAS" order="4" width="22" precision="4"
          />
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DIRECCION" datatype="vchar2" columnOrder="15"
         ...
         columnFlags="33" defaultLabel="Direccion">
          <dataDescriptor expression="HOSPITAL.DIRECCION"
    ...
    <dataSource name="Q_2">
      <select>
      <![CDATA[SELECT DISTINCT PLANTILLA_SALA.SALA_HOSP_CODIGO,
...
WHERE (PLANTILLA_SALA.PLAN_NIF = PLANTILLA.NIF)]]>
      ...
      <displayInfo x="5.40625" y="0.98962" width="2.43750" height="2.13538"/>
      <group name="G_SALA_HOSP_CODIGO">
        <displayInfo x="5.73206" y="3.62500" width="1.78589" height="1.45605"
        />
        <dataItem name="NIF" datatype="vchar2" columnOrder="17" width="9"
         defaultWidth="90000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nif">
          <dataDescriptor expression="PLANTILLA.NIF"
           descriptiveExpression="NIF" order="2" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NOMBRE1" datatype="vchar2" columnOrder="18" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nombre1">
          <dataDescriptor expression="PLANTILLA.NOMBRE"
           descriptiveExpression="NOMBRE" order="3" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="APELLIDOS" datatype="vchar2" columnOrder="19"
         width="40" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Apellidos">
          <dataDescriptor expression="PLANTILLA.APELLIDOS"
           descriptiveExpression="APELLIDOS" order="4" width="40"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="TURNO" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="20" width="1"
         defaultWidth="10000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Turno">
          <dataDescriptor expression="PLANTILLA.TURNO"
           descriptiveExpression="TURNO" order="5" width="1"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FUNCION" datatype="vchar2" columnOrder="21" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Funcion">
          <dataDescriptor expression="PLANTILLA.FUNCION"
           descriptiveExpression="FUNCION" order="6" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALA_HOSP_CODIGO" oracleDatatype="number"
         columnOrder="16" width="22" defaultWidth="40000"
         defaultHeight="10000" columnFlags="1" defaultLabel="Sala Hosp Codigo">
          <dataDescriptor expression="PLANTILLA_SALA.SALA_HOSP_CODIGO"
           descriptiveExpression="SALA_HOSP_CODIGO" order="1" width="22"
           precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALA_CODIGO" oracleDatatype="number" columnOrder="22"
         width="22" defaultWidth="40000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Sala Codigo">
          <dataDescriptor expression="PLANTILLA_SALA.SALA_CODIGO"
           descriptiveExpression="SALA_CODIGO" order="7" width="22"
           precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <link name="L_1" parentGroup="G_CODIGO" parentColumn="CODIGO"
     childQuery="Q_2" childColumn="SALA_HOSP_CODIGO" condition="eq"
     sqlClause="where"/>
  </data>
  <layout>
  <section name="main">
      ...
      <frame name="M_G_CODIGO_GRPFR">
        ...
        <repeatingFrame name="R_G_CODIGO" source="G_CODIGO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_TELEFONO" source="TELEFONO" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="0.62500" y="0.00000" width="1.62500"
             height="0.18750"/>
          ...
          <frame name="M_G_SALA_HOSP_CODIGO_GRPFR">
            <geometryInfo x="0.00000" y="0.37500" width="6.31250"
             height="0.37500"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_SALA_HOSP_CODIGO"
             source="G_SALA_HOSP_CODIGO" printDirection="down"
             minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="0.56250" width="6.31250"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              ...
              <field name="F_NOMBRE1" source="NOMBRE1" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="1.37500" y="0.56250" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_APELLIDOS" source="APELLIDOS" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.87500" y="0.56250" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_TURNO" source="TURNO" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.37500" y="0.56250" width="0.43750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_FUNCION" source="FUNCION" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.81250" y="0.56250" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_SALA_HOSP_CODIGO_HDR">
              <geometryInfo x="0.00000" y="0.37500" width="6.31250"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="allPage"
               basePrintingOn="enclosingObject"/>
              ...
              <text name="B_APELLIDOS" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.87500" y="0.37500" width="1.50000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_TURNO" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.37500" y="0.37500" width="0.43750"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_FUNCION" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.81250" y="0.37500" width="1.50000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_TELEFONO" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <field name="F_NOMBRE" source="NOMBRE" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="2.81250" y="0.00000" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          ...
          <field name="F_NUMCAMAS" source="NUMCAMAS" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="5.06250" y="0.00000" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
          </field>
          <text name="B_NUMCAMAS" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.31250" y="0.00000" width="0.75000"
             height="0.18750"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwblue" sectionTitle="Consultas enlazadas"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGCODIGOGRPFR112">
<rw:foreach id="RGCODIGO1121" src="G_CODIGO">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Consultas enlazadas <br>Telefono <rw:field id="F_TELEFONO" src="TELEFONO" breakLevel="RGCODIGO1121" breakValue="&nbsp;"> F_TELEFONO </rw:field><br>
Nombre <rw:field id="F_NOMBRE" src="NOMBRE" breakLevel="RGCODIGO1121" breakValue="&nbsp;"> F_NOMBRE </rw:field><br>
Numcamas <rw:field id="F_NUMCAMAS" src="NUMCAMAS" breakLevel="RGCODIGO1121" breakValue="&nbsp;"> F_NUMCAMAS </rw:field><br>
Direccion <rw:field id="F_DIRECCION" src="DIRECCION" breakLevel="RGCODIGO1121" breakValue="&nbsp;"> F_DIRECCION </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Consultas enlazadas">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBNIF112" asArray="no"/> class="OraColumnHeader"> Nif </th>
       <th <rw:id id="HBNOMBRE1112" asArray="no"/> class="OraColumnHeader"> Nombre1 </th>
       <th <rw:id id="HBAPELLIDOS112" asArray="no"/> class="OraColumnHeader"> Apellidos </th>
       <th <rw:id id="HBTURNO112" asArray="no"/> class="OraColumnHeader"> Turno </th>
       <th <rw:id id="HBFUNCION112" asArray="no"/> class="OraColumnHeader"> Funcion </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGSALAHOSPCODIGO1121" src="G_SALA_HOSP_CODIGO">
       <tr>
        <td <rw:headers id="HFNIF112" src="HBNIF112"/> class="OraCellText"><rw:field id="FNIF112" src="NIF" nullValue="&nbsp;"> F_NIF </rw:field></td>
        <td <rw:headers id="HFNOMBRE1112" src="HBNOMBRE1112"/> class="OraCellText"><rw:field id="FNOMBRE1112" src="NOMBRE1" nullValue="&nbsp;"> F_NOMBRE1 </rw:field></td>
        <td <rw:headers id="HFAPELLIDOS112" src="HBAPELLIDOS112"/> class="OraCellText"><rw:field id="FAPELLIDOS112" src="APELLIDOS" nullValue="&nbsp;"> F_APELLIDOS </rw:field></td>
        <td <rw:headers id="HFTURNO112" src="HBTURNO112"/> class="OraCellText"><rw:field id="FTURNO112" src="TURNO" nullValue="&nbsp;"> F_TURNO </rw:field></td>
        <td <rw:headers id="HFFUNCION112" src="HBFUNCION112"/> class="OraCellText"><rw:field id="FFUNCION112" src="FUNCION" nullValue="&nbsp;"> F_FUNCION </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
