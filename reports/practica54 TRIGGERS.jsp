...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="P_DESTINO" datatype="character" width="100"
     precision="10" initialValue="IMPRESORA"
     validationTrigger="p_destinovalidtrigger" label="P Destino"
     defaultWidth="0" defaultHeight="0">
      <listOfValues restrictToList="yes">
        <staticValues>
          <validValue value="IMPRESORA"/>
          <validValue value="PANTALLA"/>
        </staticValues>
      </listOfValues>
    </userParameter>
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL HOSPITAL_ENFERMO.HOSP_CODIGO, HOSPITAL_ENFERMO.INSCRIPCION, 
ENFERMO.NOMBRE, ENFERMO.APELLIDOS, ENFERMO.DIRECCION
FROM ENFERMO, HOSPITAL_ENFERMO
WHERE (HOSPITAL_ENFERMO.ENF_NUMSEGSOCIAL = ENFERMO.NUMSEGSOCIAL) 
ORDER BY HOSPITAL_ENFERMO.HOSP_CODIGO,ENFERMO.NOMBRE,ENFERMO.APELLIDOS]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_HOSP_CODIGO">
        <displayInfo x="0.57166" y="1.94995" width="2.85681" height="0.61963"
        />
        <dataItem name="HOSP_CODIGO" oracleDatatype="number" columnOrder="11"
         width="22" defaultWidth="40000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Hosp Codigo">
          <dataDescriptor expression="HOSPITAL_ENFERMO.HOSP_CODIGO"
           descriptiveExpression="HOSP_CODIGO" order="1" width="22"
           precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="CountINSCRIPCIONPerHOSP_CODIGO" source="INSCRIPCION"
         function="count" precision="8" reset="G_HOSP_CODIGO" compute="report"
      ...
      <group name="G_INSCRIPCION">
        <displayInfo x="1.26746" y="3.31958" width="1.46521" height="0.97949"
        />
        <dataItem name="INSCRIPCION" oracleDatatype="number" columnOrder="12"
         width="22" defaultWidth="100000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Inscripcion">
          <dataDescriptor expression="HOSPITAL_ENFERMO.INSCRIPCION"
           descriptiveExpression="INSCRIPCION" order="2" width="22"
           precision="8"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        ...
        <dataItem name="APELLIDOS" datatype="vchar2" columnOrder="14"
         ...
         columnFlags="33" defaultLabel="Apellidos">
          <dataDescriptor expression="ENFERMO.APELLIDOS"
           descriptiveExpression="APELLIDOS" order="4" width="40"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DIRECCION" datatype="vchar2" columnOrder="15"
         ...
         columnFlags="33" defaultLabel="Direccion">
          <dataDescriptor expression="ENFERMO.DIRECCION"
           descriptiveExpression="DIRECCION" order="5" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountINSCRIPCIONPerReport" source="INSCRIPCION"
  ...
  <section name="trailer">
    <body>
      <graph name="CT_1">
        <geometryInfo x="0.37500" y="0.00000" width="5.43750" height="3.06250"
        />
        <generalLayout verticalElasticity="expand"/>
        <graphDefinition>
        <![CDATA[<rw:graph id="CT_1" src="G_HOSP_CODIGO" groups="HOSP_CODIGO" dataValues="CountINSCRIPCIONPerHOSP_CODIGO">
<!--
<?xml version="1.0" ?>
<Graph version="11.1.1.0" customLayout="">
<MarkerText>
<X1ViewFormat>
<ViewFormat currencySymbol="¿"/>
</X1ViewFormat>
<Y1ViewFormat>
<ViewFormat currencySymbol="¿"/>
</Y1ViewFormat>
...
<O1Title text="Hospitales" visible="true"/>
<SliceLabel>
<ViewFormat currencySymbol="¿"/>
</SliceLabel>
<Title text="Grafico estadistico de Hospitales" visible="true"/>
<X1Axis>
<ViewFormat currencySymbol="¿"/>
</X1Axis>
...
<Y1Title text="No. de Pacientes" visible="true"/>
...
-->
  ...
  <section name="main">
    <body>
      <frame name="M_G_HOSP_CODIGO_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.87500" height="0.75000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_HOSP_CODIGO" source="G_HOSP_CODIGO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_INSCRIPCION_GRPFR">
            <geometryInfo x="0.87500" y="0.18750" width="6.00000"
             height="0.37500"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_INSCRIPCION" source="G_INSCRIPCION"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.87500" y="0.18750" width="6.00000"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_INSCRIPCION" source="INSCRIPCION"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="0.87500" y="0.18750" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_NOMBRE" source="NOMBRE" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.37500" y="0.18750" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              ...
              <field name="F_DIRECCION" source="DIRECCION" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="5.37500" y="0.18750" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_INSCRIPCION_FTR">
              <geometryInfo x="0.87500" y="0.37500" width="4.37500"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="lastPage"
               basePrintingOn="anchoringObject"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="Totals"/>
              <field name="F_CountINSCRIPCIONPerHOSP_CODI"
               source="CountINSCRIPCIONPerHOSP_CODIGO" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="0.87500" y="0.37500" width="1.50000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </frame>
          </frame>
          <field name="F_HOSP_CODIGO" source="HOSP_CODIGO" minWidowLines="1"
           spacing="0" alignment="start">
        ...
        <frame name="M_G_HOSP_CODIGO_FTR">
          <geometryInfo x="0.00000" y="0.56250" width="5.25000"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_CountINSCRIPCIONPerReport"
           source="CountINSCRIPCIONPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.87500" y="0.56250" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        ...
        <frame name="M_G_HOSP_CODIGO_HDR">
          ...
          <text name="B_HOSP_CODIGO" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_INSCRIPCION" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <text name="B_APELLIDOS" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.87500" y="0.00000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_DIRECCION" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.37500" y="0.00000" width="1.50000"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.29114" y="0.25000" width="1.91760" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10"/>
          <string>
          <![CDATA[Enfermos por hospitales]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <text name="PB_ORIENTATION" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="0.82629" width="0.71851" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
  ...
  <text name="PB_P_DESTINO" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="1.15955" width="0.61426" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="8" bold="yes"/>
      <string>
  ...
  <field name="PF_P_DESTINO" source="P_DESTINO" pageNumber="1"
   minWidowLines="1" spacing="0">
    <font size="0"/>
...
begin
    SRW.MESSAGE(1000,'Este listado muestra agrupado los enfermos de
cada hospital.');
  return (TRUE);
end;]]>
      </textSource>
...
begin
  ...
  return (TRUE);
    ...
    <function name="p_destinovalidtrigger">
      <textSource>
      <![CDATA[function P_DESTINOValidTrigger return boolean is
begin
    SRW.MESSAGE(1000,'Ha seleccionado '||:P_DESTINO||' como destino
del listado');
  return (TRUE);
end;]]>
      </textSource>
...
begin
  SRW.MESSAGE(1000,'Recuerde que los datos seleccionados para el listado son (orientacion,destino): '|| :ORIENTATION||','||:P_DESTINO);
  return (TRUE);
end;]]>
      </textSource>
    </function>
  ...
  <reportPrivate defaultReportType="tabBrkLeft" versionFlags2="0"
   templateName="rwblue" sectionTitle="Enfermos por hospitales"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGHOSPCODIGOGRPFR165">
<table class="OraTable">
<caption> Enfermos por hospitales </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBHOSPCODIGO165" asArray="no"/> class="OraColumnHeader"> Hosp Codigo </th>
   <th <rw:id id="HBINSCRIPCION165" asArray="no"/> class="OraColumnHeader"> Inscripcion </th>
   <th <rw:id id="HBNOMBRE165" asArray="no"/> class="OraColumnHeader"> Nombre </th>
   <th <rw:id id="HBAPELLIDOS165" asArray="no"/> class="OraColumnHeader"> Apellidos </th>
   <th <rw:id id="HBDIRECCION165" asArray="no"/> class="OraColumnHeader"> Direccion </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGHOSPCODIGO1651" src="G_HOSP_CODIGO">
   <rw:foreach id="RGINSCRIPCION1651" src="G_INSCRIPCION">
    <tr>
     <td <rw:id id="HFHOSPCODIGO165" breakLevel="RGHOSPCODIGO1651" asArray="no"/> class="OraRowHeader"><rw:field id="FHOSPCODIGO165" src="HOSP_CODIGO" breakLevel="RGHOSPCODIGO1651" breakValue="&nbsp;"> F_HOSP_CODIGO </rw:field></td>
     <td <rw:headers id="HFINSCRIPCION165" src="HBINSCRIPCION165, HBHOSPCODIGO165, HFHOSPCODIGO165"/> class="OraCellNumber"><rw:field id="FINSCRIPCION165" src="INSCRIPCION" nullValue="&nbsp;"> F_INSCRIPCION </rw:field></td>
     <td <rw:headers id="HFNOMBRE165" src="HBNOMBRE165, HBHOSPCODIGO165, HFHOSPCODIGO165"/> class="OraCellText"><rw:field id="FNOMBRE165" src="NOMBRE" nullValue="&nbsp;"> F_NOMBRE </rw:field></td>
     <td <rw:headers id="HFAPELLIDOS165" src="HBAPELLIDOS165, HBHOSPCODIGO165, HFHOSPCODIGO165"/> class="OraCellText"><rw:field id="FAPELLIDOS165" src="APELLIDOS" nullValue="&nbsp;"> F_APELLIDOS </rw:field></td>
     <td <rw:headers id="HFDIRECCION165" src="HBDIRECCION165, HBHOSPCODIGO165, HFHOSPCODIGO165"/> class="OraCellText"><rw:field id="FDIRECCION165" src="DIRECCION" nullValue="&nbsp;"> F_DIRECCION </rw:field></td>
    </tr>
   </rw:foreach>
   <tr>
    <th class="OraTotalText"> &nbsp; </th>
    <td <rw:headers id="HFCountINSCRIPCIONPerHOSPCODI165" src="HBINSCRIPCION165"/> class="OraTotalNumber">Recuento: <rw:field id="FCountINSCRIPCIONPerHOSPCODI165" src="CountINSCRIPCIONPerHOSP_CODIGO" nullValue="&nbsp;"> F_CountINSCRIPCIONPerHOSP_CODI </rw:field></td>
    <th class="OraTotalText"> &nbsp; </th>
    <th class="OraTotalText"> &nbsp; </th>
    <th class="OraTotalText"> &nbsp; </th>
   </tr>
 ...
 <tr>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFCountINSCRIPCIONPerReport165" src="HBINSCRIPCION165"/> class="OraTotalNumber">Recuento: <rw:field id="FCountINSCRIPCIONPerReport165" src="CountINSCRIPCIONPerReport" nullValue="&nbsp;"> F_CountINSCRIPCIONPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
