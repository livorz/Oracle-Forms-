...
<report name="EMPLEADOS_DEPARTAMENTO" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="EMPLEADOS_DEPARTAMENTO" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL DEPARTAMENTO_EMPLEADO.EMP_NIF, DEPARTAMENTO.NOMBRE, EMPLEADO.NIF, EMPLEADO.NOMBRE, EMPLEADO.COMISION, 
...
WHERE ((DEPARTAMENTO_EMPLEADO.DEPT_CODIGO = DEPARTAMENTO.CODIGO)
 AND (DEPARTAMENTO_EMPLEADO.EMP_NIF = EMPLEADO.NIF)) ]]>
      ...
      <displayInfo x="2.63538" y="0.81250" width="8.61462" height="3.27087"/>
      <group name="G_1">
        <displayInfo x="1.00818" y="4.83337" width="1.98376" height="0.77246"
        />
        <dataItem name="NOMBRE" datatype="vchar2" columnOrder="12" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nombre">
          <dataDescriptor expression="DEPARTAMENTO.NOMBRE"
           descriptiveExpression="NOMBRE" order="2" width="20"/>
      ...
      <group name="G_EMP_NIF">
        <displayInfo x="1.38318" y="6.18494" width="1.23376" height="1.45605"
        />
        <dataItem name="NIF" datatype="vchar2" columnOrder="13" width="9"
         defaultWidth="90000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nif">
          <dataDescriptor expression="EMPLEADO.NIF"
           descriptiveExpression="NIF" order="3" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NOMBRE1" datatype="vchar2" columnOrder="14" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nombre1">
          <dataDescriptor expression="EMPLEADO.NOMBRE"
           descriptiveExpression="NOMBRE" order="4" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="APELLIDOS" datatype="vchar2" columnOrder="18"
         ...
         columnFlags="33" defaultLabel="Apellidos">
          <dataDescriptor expression="EMPLEADO.APELLIDOS"
           descriptiveExpression="APELLIDOS" order="8" width="40"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COMISION" oracleDatatype="number" columnOrder="15"
         ...
         columnFlags="33" defaultLabel="Comision">
          <dataDescriptor expression="EMPLEADO.COMISION"
           descriptiveExpression="COMISION" order="5" width="22" scale="2"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALARIO" oracleDatatype="number" columnOrder="16"
         width="22" defaultWidth="80000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Salario">
          <dataDescriptor expression="EMPLEADO.SALARIO"
           descriptiveExpression="SALARIO" order="6" width="22" scale="2"
           precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="OFICIO" datatype="vchar2" columnOrder="17" width="20"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Oficio">
          <dataDescriptor expression="EMPLEADO.OFICIO"
           descriptiveExpression="OFICIO" order="7" width="20"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="EMP_NIF" datatype="vchar2" columnOrder="11" width="9"
         defaultWidth="90000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Emp Nif">
          <dataDescriptor expression="DEPARTAMENTO_EMPLEADO.EMP_NIF"
           descriptiveExpression="EMP_NIF" order="1" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <formula name="LISCONVERPTAS" source="lisconverptasformula"
     ...
     defaultHeight="0" columnFlags="16" breakOrder="none">
      <displayInfo x="0.41663" y="0.53125" width="1.81250" height="0.33337"/>
    </formula>
    <summary name="CountEMP_NIFPerReport" source="SALARIO" function="sum"
     ...
     defaultHeight="10000" columnFlags="552" defaultLabel="Recuento:">
      <displayInfo x="0.44788" y="0.13538" width="1.71875" height="0.19995"/>
    </summary>
  </data>
  <layout>
  <section name="main">
    <body>
      ...
      <frame name="M_G_1_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.50000" height="1.00000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_EMP_NIF" source="G_EMP_NIF"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <field name="F_NIF" source="NIF" minWidowLines="1" spacing="0"
           alignment="start">
          ...
          <field name="F_NOMBRE1" source="NOMBRE1" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="0.81250" y="0.37500" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_APELLIDOS" source="APELLIDOS" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.75000" y="0.37500" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_COMISION" source="COMISION" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.68750" y="0.37500" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SALARIO" source="SALARIO" minWidowLines="1"
           formatMask="NNNGNN0DNN" spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="3.87500" y="0.37500" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_OFICIO" source="OFICIO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="5.06250" y="0.37500" width="0.93750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_EMP_NIF" source="EMP_NIF" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="6.00000" y="0.37500" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_EMP_NIF_HDR">
          ...
          <text name="B_NIF" minWidowLines="1">
          ...
          <text name="B_NOMBRE1" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.81250" y="0.18750" width="0.93750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_APELLIDOS" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.75000" y="0.18750" width="0.93750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_COMISION" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.68750" y="0.18750" width="1.18750"
             height="0.18750"/>
          ...
          <text name="B_SALARIO" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="3.87500" y="0.18750" width="1.18750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes" textColor="white"/>
          ...
          <text name="B_OFICIO" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="5.06250" y="0.18750" width="0.93750"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="r25g50b75"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes" textColor="white"/>
      ...
      <repeatingFrame name="R_G_1" source="G_1" printDirection="down"
       minWidowRecords="1" columnMode="no">
        <geometryInfo x="0.00000" y="0.00000" width="7.31250" height="1.06250"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="TableCell"/>
        ...
        <frame name="M_G_EMP_NIF_GRPFR">
          <geometryInfo x="0.00000" y="0.18750" width="7.31250"
           height="0.87500"/>
          <generalLayout verticalElasticity="variable"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="r100g100b100"/>
          <frame name="M_G_EMP_NIF_FTR">
            <geometryInfo x="0.00000" y="0.56250" width="7.31250"
             height="0.50000"/>
            ...
            <text name="B_CONVERSIONPTAS" minWidowLines="1">
              <textSettings spacing="0"/>
              <geometryInfo x="2.18750" y="0.75000" width="1.06250"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="allPage"
               basePrintingOn="enclosingObject"/>
              <visualSettings fillBackgroundColor="TableHeading"/>
              <textSegment>
                <font face="helvetica" size="10" bold="yes"
                 textColor="TextColor"/>
                <string>
                <![CDATA[Conversionptas]]>
                </string>
              </textSegment>
            </text>
            <field name="F_CountEMP_NIFPerNOMBRE"
             source="CountEMP_NIFPerNOMBRE" minWidowLines="1" spacing="0"
             alignment="end">
              <font face="helvetica" size="10" bold="yes" textColor="r88g0b0"
              />
              <geometryInfo x="3.87500" y="0.56250" width="1.18750"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
            </field>
            <field name="F_CONVERSIONPTAS" source="CONVERSIONPTAS"
             ...
             alignment="end">
              <font face="helvetica" size="10" bold="yes"
               textColor="TextColor"/>
              <geometryInfo x="3.25000" y="0.75000" width="1.81250"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <advancedLayout printObjectOnPage="allPage"
               basePrintingOn="enclosingObject"/>
      ...
      <frame name="M_G_1_FTR">
        <geometryInfo x="0.00000" y="1.06250" width="7.50000" height="0.18750"
        />
        <advancedLayout printObjectOnPage="lastPage"
         basePrintingOn="anchoringObject"/>
        ...
        <field name="F_CountEMP_NIFPerReport" source="CountEMP_NIFPerReport"
         minWidowLines="1" spacing="0" alignment="start">
          <font face="helvetica" size="10" bold="yes" textColor="r25g50b0"/>
          <geometryInfo x="4.12500" y="1.06250" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <text name="B_CountEMP_NIFPerReport" minWidowLines="1">
          <textSettings spacing="0"/>
          <geometryInfo x="3.12500" y="1.06250" width="0.68750"
           height="0.18750"/>
          <textSegment>
            <font face="helvetica" size="10" bold="yes"/>
            <string>
        ...
        <field name="F_LISCONVERPTAS" source="LISCONVERPTAS" minWidowLines="1"
         formatMask="NNNGNNNGNN0" spacing="0" alignment="end">
          <font face="helvetica" size="10" bold="yes"/>
          <geometryInfo x="2.18750" y="1.06250" width="0.93750"
           height="0.18750"/>
          <advancedLayout formatTrigger="f_lisconverptasformattrigger"/>
          <visualSettings linePattern="solid"/>
        </field>
        <text name="B_1" minWidowLines="1">
          <textSettings justify="end" spacing="0"/>
          <geometryInfo x="0.00000" y="1.06250" width="2.16663"
           height="0.16663"/>
          <textSegment>
            <font face="helvetica" size="10" bold="yes"/>
            <string>
            <![CDATA[Total mensual(12 pagos) en ptas:]]>
            </string>
          </textSegment>
        </text>
      </frame>
    ...
    <margin>
      <image name="B_2">
        <geometryInfo x="0.50000" y="0.12500" width="1.25000" height="0.75000"
        />
        <visualSettings fillPattern="transparent" fillBackgroundColor="black"
         linePattern="transparent" lineBackgroundColor="black"/>
        <points>
          <point x="0.00000" y="0.00000"/>
          <point x="1.25000" y="0.75000"/>
          <point x="0.50000" y="0.12500"/>
          <point x="1.25000" y="0.75000"/>
        </points>
...
10ED250D 94611DA8 24910BC6 410CB88B AA9126F0 5F1BD796 02F3FF9D
      ...
      <text name="B_3" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="2.50000" y="0.31250" width="4.56250" height="0.25000"
        />
        <textSegment>
...
BRUTO NUMBER(10);
begin
	SELECT ROUND(ROUND(SUM(NVL(SALARIO,0) + NVL(COMISION,0)) * 166.356)/12) INTO BRUTO FROM EMPLEADO;
	RETURN BRUTO;
end;]]>
      </textSource>
    </function>
    <function name="f_lisconverptasformattrigger">
      <textSource>
      <![CDATA[function F_LISCONVERPTASFormatTrigger return boolean is
begin
...
<rw:dataArea id="MG1GRPFR175">
<rw:foreach id="RG11751" src="G_1">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader">  <br>Nombre <rw:field id="F_NOMBRE" src="NOMBRE" breakLevel="RG11751" breakValue="&nbsp;"> F_NOMBRE </rw:field><br>
Conversionptas <rw:field id="F_CONVERSIONPTAS" src="CONVERSIONPTAS" breakLevel="RG11751" breakValue="&nbsp;"> F_CONVERSIONPTAS </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    ...
    <table class="OraTable" summary="">
     ...
     <thead>
      <tr>
       <th <rw:id id="HBNIF175" asArray="no"/> class="OraColumnHeader"> Nif </th>
       <th <rw:id id="HBNOMBRE1175" asArray="no"/> class="OraColumnHeader"> Nombre1 </th>
       <th <rw:id id="HBAPELLIDOS175" asArray="no"/> class="OraColumnHeader"> Apellidos </th>
       <th <rw:id id="HBCOMISION175" asArray="no"/> class="OraColumnHeader"> Comision </th>
       <th <rw:id id="HBSALARIO175" asArray="no"/> class="OraColumnHeader"> Salario </th>
       <th <rw:id id="HBOFICIO175" asArray="no"/> class="OraColumnHeader"> Oficio </th>
       <th <rw:id id="HBEMPNIF175" asArray="no"/> class="OraColumnHeader"> Emp Nif </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGEMPNIF1751" src="G_EMP_NIF">
       <tr>
        <td <rw:headers id="HFNIF175" src="HBNIF175"/> class="OraCellText"><rw:field id="FNIF175" src="NIF" nullValue="&nbsp;"> F_NIF </rw:field></td>
        <td <rw:headers id="HFNOMBRE1175" src="HBNOMBRE1175"/> class="OraCellText"><rw:field id="FNOMBRE1175" src="NOMBRE1" nullValue="&nbsp;"> F_NOMBRE1 </rw:field></td>
        <td <rw:headers id="HFAPELLIDOS175" src="HBAPELLIDOS175"/> class="OraCellText"><rw:field id="FAPELLIDOS175" src="APELLIDOS" nullValue="&nbsp;"> F_APELLIDOS </rw:field></td>
        <td <rw:headers id="HFCOMISION175" src="HBCOMISION175"/> class="OraCellNumber"><rw:field id="FCOMISION175" src="COMISION" nullValue="&nbsp;"> F_COMISION </rw:field></td>
        <td <rw:headers id="HFSALARIO175" src="HBSALARIO175"/> class="OraCellNumber"><rw:field id="FSALARIO175" src="SALARIO" nullValue="&nbsp;"> F_SALARIO </rw:field></td>
        <td <rw:headers id="HFOFICIO175" src="HBOFICIO175"/> class="OraCellText"><rw:field id="FOFICIO175" src="OFICIO" nullValue="&nbsp;"> F_OFICIO </rw:field></td>
        <td <rw:headers id="HFEMPNIF175" src="HBEMPNIF175"/> class="OraCellText"><rw:field id="FEMPNIF175" src="EMP_NIF" nullValue="&nbsp;"> F_EMP_NIF </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFCountEMPNIFPerNOMBRE175" src="HBSALARIO175"/> class="OraTotalNumber">Recuento: <rw:field id="FCountEMPNIFPerNOMBRE175" src="CountEMP_NIFPerNOMBRE" nullValue="&nbsp;"> F_CountEMP_NIFPerNOMBRE </rw:field></td>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
     </tr>
     <tr>
      <td  class="OraTotalNumber">Nombre <rw:field id="FNOMBRE175" src="NOMBRE" nullValue="&nbsp;"> F_NOMBRE </rw:field></td>
      <td  class="OraTotalNumber">Conversionptas <rw:field id="FCONVERSIONPTAS175" src="CONVERSIONPTAS" nullValue="&nbsp;"> F_CONVERSIONPTAS </rw:field></td>
     </tr>
    </table>
   </td>
  </tr>
