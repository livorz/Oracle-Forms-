...
<report name="practica52 PARAMETROS" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="P_CODEPARTAMENTO" datatype="number" precision="10"
     defaultWidth="0" defaultHeight="0">
      <listOfValues restrictToList="yes">
        <selectStatement hideFirstColumn="no">
        <![CDATA[SELECT ALL DEPARTAMENTO.CODIGO FROM DEPARTAMENTO]]>
        </selectStatement>
      </listOfValues>
    </userParameter>
    <systemParameter name="MODE" initialValue="Default"/>
    <systemParameter name="ORIENTATION" initialValue="Default"/>
    <systemParameter name="DESFORMAT" display="yes"/>
    <systemParameter name="DESNAME" display="yes"/>
    <systemParameter name="DESTYPE" display="yes"/>
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL EMPLEADO.NIF, EMPLEADO.FALTA, EMPLEADO.NOMBRE,EMPLEADO.COMISION,EMPLEADO.SALARIO,EMPLEADO.OFICIO, EMPLEADO.APELLIDOS, EMPLEADO.NIF_DEPENDIENTE, EMPLEADO.DESEMPLEADO, EMPLEADO.NIVEL_ESTUDIOS, EMPLEADO.IMAGEN_EMP, DEPARTAMENTO_EMPLEADO.DEPT_CODIGO FROM EMPLEADO, DEPARTAMENTO_EMPLEADO WHERE (DEPARTAMENTO_EMPLEADO.EMP_NIF = EMPLEADO.NIF)
AND DEPARTAMENTO_EMPLEADO.DEPT_CODIGO = :P_CODEPARTAMENTO]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_2">
        <displayInfo x="0.79138" y="1.94995" width="2.41736" height="0.77246"
        />
        <dataItem name="DEPT_CODIGO" oracleDatatype="number" columnOrder="22"
         width="22" defaultWidth="40000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Dept Codigo">
          <dataDescriptor expression="DEPARTAMENTO_EMPLEADO.DEPT_CODIGO"
           descriptiveExpression="DEPT_CODIGO" order="12"
           oracleDatatype="number" width="22" precision="2"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="CountNIFPerDEPT_CODIGO" source="NIF" function="count"
         precision="8" reset="G_2" compute="report" defaultWidth="100000"
         defaultHeight="10000" columnFlags="520" defaultLabel="Recuento:">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
           height="0.00000"/>
        </summary>
        <summary name="SumSALARIOPerDEPT_CODIGO" source="SALARIO"
         function="sum" width="22" precision="6" scale="2" reset="G_2"
         compute="report" defaultWidth="80000" defaultHeight="10000"
      ...
      <group name="G_1">
        <displayInfo x="1.12097" y="3.49951" width="1.75818" height="1.62695"
        />
        <dataItem name="NOMBRE" datatype="vchar2" columnOrder="13" width="20"
        ...
        <dataItem name="SALARIO" oracleDatatype="number" columnOrder="15"
         ...
         columnFlags="33" defaultLabel="Salario">
          <dataDescriptor expression="EMPLEADO.SALARIO"
           descriptiveExpression="SALARIO" order="5" oracleDatatype="number"
           width="22" scale="2" precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NIF" datatype="vchar2" columnOrder="11" width="9"
         defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Nif">
          <dataDescriptor expression="EMPLEADO.NIF"
           descriptiveExpression="NIF" order="1" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FALTA" datatype="vchar2" columnOrder="12" width="240"
         defaultWidth="100000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Falta">
          <dataDescriptor expression="EMPLEADO.FALTA"
           descriptiveExpression="FALTA" order="2" width="240"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COMISION" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="80000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Comision">
          <dataDescriptor expression="EMPLEADO.COMISION"
           descriptiveExpression="COMISION" order="4" oracleDatatype="number"
           width="22" scale="2" precision="6"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NIF_DEPENDIENTE" datatype="vchar2" columnOrder="18"
         width="9" defaultWidth="90000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Nif Dependiente">
          <dataDescriptor expression="EMPLEADO.NIF_DEPENDIENTE"
           descriptiveExpression="NIF_DEPENDIENTE" order="8" width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="DESEMPLEADO" datatype="character"
         oracleDatatype="aFixedChar" columnOrder="19" width="1"
         defaultWidth="10000" defaultHeight="10000" columnFlags="1"
         defaultLabel="Desempleado">
          <dataDescriptor expression="EMPLEADO.DESEMPLEADO"
           descriptiveExpression="DESEMPLEADO" order="9"
           oracleDatatype="aFixedChar" width="1"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="NIVEL_ESTUDIOS" oracleDatatype="number"
         columnOrder="20" width="22" defaultWidth="30000"
         defaultHeight="10000" columnFlags="1" defaultLabel="Nivel Estudios">
          <dataDescriptor expression="EMPLEADO.NIVEL_ESTUDIOS"
           descriptiveExpression="NIVEL_ESTUDIOS" order="10"
           oracleDatatype="number" width="22" precision="1"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="IMAGEN_EMP" datatype="longRaw"
         oracleDatatype="longBinary" columnOrder="21" width="0"
         defaultWidth="200000" defaultHeight="100000" columnFlags="0"
         defaultLabel="Imagen Emp" breakOrder="none">
          <dataDescriptor expression="EMPLEADO.IMAGEN_EMP"
           descriptiveExpression="IMAGEN_EMP" order="11"
           oracleDatatype="longBinary"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountNIFPerReport" source="NIF" function="count"
    ...
    <summary name="SumSALARIOPerReport" source="SALARIO" function="sum"
     width="22" precision="6" scale="2" reset="report" compute="report"
  ...
  <section name="main">
    <body>
      <frame name="M_G_2_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="5.68750" height="0.93750"
        />
        ...
        <repeatingFrame name="R_G_2" source="G_2" printDirection="down"
         minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.00000" width="5.68750"
           height="0.75000"/>
          <generalLayout verticalElasticity="variable"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="TableCell"/>
          <field name="F_DEPT_CODIGO" source="DEPT_CODIGO" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
            <geometryInfo x="0.87500" y="0.00000" width="0.62500"
             height="0.18750"/>
          ...
          <frame name="M_G_1_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="5.68750"
             height="0.56250"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_1" source="G_1" printDirection="down"
             minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="0.37500" width="5.68750"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              <field name="F_NOMBRE" source="NOMBRE" minWidowLines="1"
               spacing="0" alignment="start">
              ...
              <field name="F_SALARIO" source="SALARIO" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.50000" y="0.37500" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_1_FTR">
              <geometryInfo x="0.00000" y="0.56250" width="5.68750"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="lastPage"
               basePrintingOn="anchoringObject"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="Totals"/>
              <field name="F_SumSALARIOPerDEPT_CODIGO"
               source="SumSALARIOPerDEPT_CODIGO" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="4.50000" y="0.56250" width="1.18750"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            ...
            <frame name="M_G_1_HDR">
              ...
              <text name="B_SALARIO" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.50000" y="0.18750" width="1.18750"
                 height="0.18750"/>
          ...
          <text name="B_DEPT_CODIGO" minWidowLines="1">
            <textSettings spacing="0"/>
          ...
          <field name="F_CountNIFPerDEPT_CODIGO"
           source="CountNIFPerDEPT_CODIGO" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
            />
          ...
          <text name="B_CountNIFPerDEPT_CODIGO" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.50000" y="0.00000" width="0.68750"
             height="0.18750"/>
            <advancedLayout printObjectOnPage="allPage"
             basePrintingOn="enclosingObject"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
        ...
        <frame name="M_G_2_FTR">
          ...
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_SumSALARIOPerReport" source="SumSALARIOPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.43750" y="0.75000" width="1.18750"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_SumSALARIOPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
      ...
      <frame name="M_Oficio_FTR">
        <geometryInfo x="0.00000" y="0.93750" width="2.18750" height="0.18750"
        />
        <visualSettings fillPattern="transparent" fillBackgroundColor="Totals"/>
        <field name="F_CountNIFPerReport" source="CountNIFPerReport"
         minWidowLines="1" spacing="0" alignment="start">
          <font face="helvetica" size="10" bold="yes" textColor="TextColor"/>
          <geometryInfo x="0.68750" y="0.93750" width="1.50000"
           height="0.18750"/>
          <generalLayout verticalElasticity="expand"/>
        </field>
        <text name="B_CountNIFPerReport" minWidowLines="1">
          <textSettings spacing="0"/>
          <geometryInfo x="0.00000" y="0.93750" width="0.68750"
           height="0.18750"/>
          <visualSettings fillBackgroundColor="TableHeading"/>
          <textSegment>
            <font face="helvetica" size="10" bold="yes" textColor="TextColor"
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.16614" y="0.25000" width="2.16772" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10"/>
          <string>
          <![CDATA[Empleados por departamento]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <text name="PB_3" pageNumber="1" minWidowLines="1">
    ...
    <geometryInfo x="0.48267" y="1.86780" width="0.89221" height="0.14929"/>
  ...
  <field name="PF_CODPTO" source="P_CODEPARTAMENTO" pageNumber="1"
   minWidowLines="1" spacing="0">
    <font size="0"/>
    <geometryInfo x="1.52075" y="1.79175" width="1.97925" height="0.23962"/>
  ...
  <text name="PB_2" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.58167" y="0.49304" width="2.86426" height="0.18042"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="10" bold="yes"/>
      <string>
      <![CDATA[Introduzca valores para los parámetros]]>
      </string>
    </textSegment>
  </text>
  ...
  <text name="PB_DESNAME" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="1.15955" width="1.16638" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="8" bold="yes"/>
      <string>
      <![CDATA[Nombre de Destino]]>
      </string>
    </textSegment>
  </text>
  ...
  <text name="PB_1" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="1.01392" y="0.15979" width="1.99976" height="0.22205"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="12" bold="yes"/>
      <string>
      <![CDATA[Parámetros del Informe]]>
      </string>
    </textSegment>
  </text>
  <text name="PB_DESFORMAT" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="1.49280" width="1.18726" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="8" bold="yes"/>
      <string>
      <![CDATA[Formato de Destino]]>
      </string>
    </textSegment>
  </text>
  <text name="PB_DESTYPE" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="0.82629" width="0.97888" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="8" bold="yes"/>
      <string>
      <![CDATA[Tipo de Destino]]>
      </string>
    </textSegment>
  </text>
  </parameterForm>
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwblue" sectionTitle="Empleados por departamento"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MG2GRPFR209">
<rw:foreach id="RG22091" src="G_2">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Empleados por departamento <br>Dept Codigo <rw:field id="F_DEPT_CODIGO" src="DEPT_CODIGO" breakLevel="RG22091" breakValue="&nbsp;"> F_DEPT_CODIGO </rw:field><br>
Recuento: <rw:field id="F_CountNIFPerDEPT_CODIGO" src="CountNIFPerDEPT_CODIGO" breakLevel="RG22091" breakValue="&nbsp;"> F_CountNIFPerDEPT_CODIGO </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Empleados por departamento">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBNOMBRE209" asArray="no"/> class="OraColumnHeader"> Nombre </th>
       <th <rw:id id="HBAPELLIDOS209" asArray="no"/> class="OraColumnHeader"> Apellidos </th>
       <th <rw:id id="HBOFICIO209" asArray="no"/> class="OraColumnHeader"> Oficio </th>
       <th <rw:id id="HBSALARIO209" asArray="no"/> class="OraColumnHeader"> Salario </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RG12091" src="G_1">
       <tr>
        <td <rw:headers id="HFNOMBRE209" src="HBNOMBRE209"/> class="OraCellText"><rw:field id="FNOMBRE209" src="NOMBRE" nullValue="&nbsp;"> F_NOMBRE </rw:field></td>
        <td <rw:headers id="HFAPELLIDOS209" src="HBAPELLIDOS209"/> class="OraCellText"><rw:field id="FAPELLIDOS209" src="APELLIDOS" nullValue="&nbsp;"> F_APELLIDOS </rw:field></td>
        <td <rw:headers id="HFOFICIO209" src="HBOFICIO209"/> class="OraCellText"><rw:field id="FOFICIO209" src="OFICIO" nullValue="&nbsp;"> F_OFICIO </rw:field></td>
        <td <rw:headers id="HFSALARIO209" src="HBSALARIO209"/> class="OraCellNumber"><rw:field id="FSALARIO209" src="SALARIO" nullValue="&nbsp;"> F_SALARIO </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFSumSALARIOPerDEPTCODIGO209" src="HBSALARIO209"/> class="OraTotalNumber">Total: <rw:field id="FSumSALARIOPerDEPTCODIGO209" src="SumSALARIOPerDEPT_CODIGO" nullValue="&nbsp;"> F_SumSALARIOPerDEPT_CODIGO </rw:field></td>
     </tr>
     <tr>
      <td  class="OraTotalNumber">Dept Codigo <rw:field id="FDEPTCODIGO209" src="DEPT_CODIGO" nullValue="&nbsp;"> F_DEPT_CODIGO </rw:field></td>
      <td  class="OraTotalNumber">Recuento: <rw:field id="FCountNIFPerDEPTCODIGO209" src="CountNIFPerDEPT_CODIGO" nullValue="&nbsp;"> F_CountNIFPerDEPT_CODIGO </rw:field></td>
     </tr>
    </table>
   </td>
  </tr>
...
<table class="OraTable" summary="Empleados por departamento">
 <tr>
  <th class="OraTotalNumber"> Recuento: <rw:field id="F_CountNIFPerReport" src="CountNIFPerReport" nullValue="&nbsp;"> F_CountNIFPerReport </rw:field></th>
  <th class="OraTotalNumber"> Total: <rw:field id="F_SumSALARIOPerReport" src="SumSALARIOPerReport" nullValue="&nbsp;"> F_SumSALARIOPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MG2GRPFR209" -->
