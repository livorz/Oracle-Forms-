...
<report name="ENFERMOS_HOSPITAL2" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="ENFERMOS_HOSPITAL2" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="P_HOSP_CODIGO" datatype="number" precision="10"
     validationTrigger="p_hosp_codigovalidtrigger" label="P Hosp Codigo"
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL HOSPITAL.CODIGO, HOSPITAL.NOMBRE, 
HOSPITAL_ENFERMO.HOSP_CODIGO, HOSPITAL_ENFERMO.ENF_NUMSEGSOCIAL, ENFERMO.NUMSEGSOCIAL, ENFERMO.NOMBRE, ENFERMO.APELLIDOS, ENFERMO.DIRECCION, 
ENFERMO.FNACIMIENTO, ENFERMO.SEXO, ENFERMO.FOTOCASA
...
AND HOSPITAL_ENFERMO.HOSP_CODIGO = :P_HOSP_CODIGO]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_CODIGO">
        <displayInfo x="0.71814" y="1.94995" width="2.56384" height="0.77246"
        />
        <dataItem name="CODIGO" oracleDatatype="number" columnOrder="11"
         ...
         defaultLabel="Codigo">
          <dataDescriptor expression="HOSPITAL.CODIGO"
           descriptiveExpression="CODIGO" order="1" oracleDatatype="number"
        ...
        <summary name="CountNUMSEGSOCIALPerCODIGO" source="NUMSEGSOCIAL"
         function="count" precision="8" reset="G_CODIGO" compute="report"
         defaultWidth="100000" defaultHeight="10000" columnFlags="520"
         defaultLabel="Recuento:">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
           height="0.00000"/>
        </summary>
      </group>
      <group name="G_NUMSEGSOCIAL">
        <displayInfo x="1.08435" y="3.31958" width="1.83142" height="1.62695"
        />
        <dataItem name="NUMSEGSOCIAL" oracleDatatype="number" columnOrder="15"
         width="22" defaultWidth="110000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Numsegsocial">
          <dataDescriptor expression="ENFERMO.NUMSEGSOCIAL"
           descriptiveExpression="NUMSEGSOCIAL" order="5"
        ...
        <dataItem name="DIRECCION" datatype="vchar2" columnOrder="18"
         ...
         columnFlags="33" defaultLabel="Direccion">
          <dataDescriptor expression="ENFERMO.DIRECCION"
           descriptiveExpression="DIRECCION" order="8" width="50"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FNACIMIENTO" datatype="date" oracleDatatype="date"
         columnOrder="19" width="9" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Fnacimiento">
          <dataDescriptor expression="ENFERMO.FNACIMIENTO"
           descriptiveExpression="FNACIMIENTO" order="9" oracleDatatype="date"
           width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SEXO" datatype="character" oracleDatatype="aFixedChar"
         columnOrder="20" width="1" defaultWidth="10000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Sexo">
          <dataDescriptor expression="ENFERMO.SEXO"
           descriptiveExpression="SEXO" order="10" oracleDatatype="aFixedChar"
           width="1"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="FOTOCASA" datatype="longRaw"
         oracleDatatype="longBinary" columnOrder="21" width="0"
         defaultWidth="200000" defaultHeight="100000" columnFlags="32"
         defaultLabel="Fotocasa" breakOrder="none">
          <dataDescriptor expression="ENFERMO.FOTOCASA"
           descriptiveExpression="FOTOCASA" order="11"
        ...
        <dataItem name="HOSP_CODIGO" oracleDatatype="number" columnOrder="13"
         ...
         defaultLabel="Hosp Codigo">
          <dataDescriptor expression="HOSPITAL_ENFERMO.HOSP_CODIGO"
           descriptiveExpression="HOSP_CODIGO" order="3"
        ...
        <dataItem name="ENF_NUMSEGSOCIAL" oracleDatatype="number"
         ...
         defaultHeight="10000" columnFlags="1" defaultLabel="Enf Numsegsocial">
          <dataDescriptor expression="HOSPITAL_ENFERMO.ENF_NUMSEGSOCIAL"
           descriptiveExpression="ENF_NUMSEGSOCIAL" order="4"
           oracleDatatype="number" width="22" precision="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="CountNUMSEGSOCIALPerReport" source="NUMSEGSOCIAL"
  ...
  <section name="main">
    <body>
      <frame name="M_G_CODIGO_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="7.50000" height="1.62500"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_CODIGO" source="G_CODIGO"
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_NUMSEGSOCIAL_GRPFR">
            <geometryInfo x="0.00000" y="0.18750" width="7.50000"
             height="1.25000"/>
            <generalLayout verticalElasticity="variable"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="r100g100b100"/>
            <repeatingFrame name="R_G_NUMSEGSOCIAL" source="G_NUMSEGSOCIAL"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <field name="F_APELLIDOS" source="APELLIDOS" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.43750" y="0.37500" width="0.81250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_DIRECCION" source="DIRECCION" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="3.25000" y="0.37500" width="0.81250"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_FNACIMIENTO" source="FNACIMIENTO"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="4.06250" y="0.37500" width="1.37500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_SEXO" source="SEXO" minWidowLines="1" spacing="0"
               alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="5.43750" y="0.37500" width="0.37500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_FOTOCASA" source="FOTOCASA" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="5.81250" y="0.37500" width="1.68750"
                 height="0.87500"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_NUMSEGSOCIAL_FTR">
              ...
              <field name="F_CountNUMSEGSOCIALPerCODIGO"
               source="CountNUMSEGSOCIALPerCODIGO" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="0.00000" y="1.25000" width="1.62500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </frame>
            <frame name="M_G_NUMSEGSOCIAL_HDR">
              <geometryInfo x="0.00000" y="0.18750" width="7.50000"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="allPage"
               basePrintingOn="enclosingObject"/>
              ...
              <text name="B_APELLIDOS" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.43750" y="0.18750" width="0.81250"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_DIRECCION" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="3.25000" y="0.18750" width="0.81250"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_FNACIMIENTO" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="4.06250" y="0.18750" width="1.37500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="TableHeading"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_SEXO" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="5.43750" y="0.18750" width="0.37500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_FOTOCASA" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="5.81250" y="0.18750" width="1.68750"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
          ...
          <field name="F_NOMBRE" source="NOMBRE" minWidowLines="1"
           spacing="single" alignment="start">
            <font face="Arial" size="10" bold="yes" textColor="TableHeading"/>
            <geometryInfo x="2.12500" y="0.00000" width="0.93750"
             height="0.18750"/>
            <advancedLayout formatTrigger="f_1formattrigger"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="Totals" linePattern="solid"/>
          </field>
          <text name="B_CODIGO1" minWidowLines="1">
            <textSettings spacing="0"/>
        ...
        <frame name="M_G_CODIGO_FTR">
          <geometryInfo x="0.00000" y="1.43750" width="7.50000"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_CountNUMSEGSOCIALPerReport"
           source="CountNUMSEGSOCIALPerReport" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.68750" y="1.43750" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_CountNUMSEGSOCIALPerReport" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="1.43750" width="0.68750"
             height="0.18750"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"/>
              <string>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.37451" y="0.25000" width="1.75085" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10"/>
          <string>
          <![CDATA[Pacientes en hospital]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <text name="PB_ORIENTATION" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="1.15955" width="0.71851" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="8" bold="yes"/>
      <string>
  ...
  <text name="PB_P_HOSP_CODIGO" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.24316" y="1.49280" width="0.91638" height="0.14929"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="8" bold="yes"/>
      <string>
  ...
  <field name="PF_ORIENTATION" source="ORIENTATION" pageNumber="1"
   minWidowLines="1" spacing="0">
    <font size="0"/>
    <geometryInfo x="1.50000" y="1.11755" width="2.00000" height="0.26428"/>
    <visualSettings lineWidth="1" linePattern="solid"/>
  </field>
  <field name="PF_P_HOSP_CODIGO" source="P_HOSP_CODIGO" pageNumber="1"
   minWidowLines="1" spacing="0">
    <font size="0"/>
...
begin
  ...
  return (TRUE);
    ...
    <function name="p_hosp_codigovalidtrigger">
      <textSource>
      <![CDATA[function P_HOSP_CODIGOValidTrigger return boolean is
begin
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwblue" sectionTitle="Pacientes en hospital"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGCODIGOGRPFR214">
<rw:foreach id="RGCODIGO2141" src="G_CODIGO">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Pacientes en hospital <br>Codigo <rw:field id="F_CODIGO" src="CODIGO" breakLevel="RGCODIGO2141" breakValue="&nbsp;"> F_CODIGO </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Pacientes en hospital">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBNUMSEGSOCIAL214" asArray="no"/> class="OraColumnHeader"> Numsegsocial </th>
       <th <rw:id id="HBNOMBRE1214" asArray="no"/> class="OraColumnHeader"> Nombre1 </th>
       <th <rw:id id="HBAPELLIDOS214" asArray="no"/> class="OraColumnHeader"> Apellidos </th>
       <th <rw:id id="HBDIRECCION214" asArray="no"/> class="OraColumnHeader"> Direccion </th>
       <th <rw:id id="HBFNACIMIENTO214" asArray="no"/> class="OraColumnHeader"> Fnacimiento </th>
       <th <rw:id id="HBSEXO214" asArray="no"/> class="OraColumnHeader"> Sexo </th>
       <th <rw:id id="HBFOTOCASA214" asArray="no"/> class="OraColumnHeader"> Fotocasa </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGNUMSEGSOCIAL2141" src="G_NUMSEGSOCIAL">
       <tr>
        <td <rw:headers id="HFNUMSEGSOCIAL214" src="HBNUMSEGSOCIAL214"/> class="OraCellNumber"><rw:field id="FNUMSEGSOCIAL214" src="NUMSEGSOCIAL" nullValue="&nbsp;"> F_NUMSEGSOCIAL </rw:field></td>
        <td <rw:headers id="HFNOMBRE1214" src="HBNOMBRE1214"/> class="OraCellText"><rw:field id="FNOMBRE1214" src="NOMBRE1" nullValue="&nbsp;"> F_NOMBRE1 </rw:field></td>
        <td <rw:headers id="HFAPELLIDOS214" src="HBAPELLIDOS214"/> class="OraCellText"><rw:field id="FAPELLIDOS214" src="APELLIDOS" nullValue="&nbsp;"> F_APELLIDOS </rw:field></td>
        <td <rw:headers id="HFDIRECCION214" src="HBDIRECCION214"/> class="OraCellText"><rw:field id="FDIRECCION214" src="DIRECCION" nullValue="&nbsp;"> F_DIRECCION </rw:field></td>
        <td <rw:headers id="HFFNACIMIENTO214" src="HBFNACIMIENTO214"/> class="OraCellText"><rw:field id="FFNACIMIENTO214" src="FNACIMIENTO" nullValue="&nbsp;"> F_FNACIMIENTO </rw:field></td>
        <td <rw:headers id="HFSEXO214" src="HBSEXO214"/> class="OraCellText"><rw:field id="FSEXO214" src="SEXO" nullValue="&nbsp;"> F_SEXO </rw:field></td>
        <td <rw:headers id="HFFOTOCASA214" src="HBFOTOCASA214"/> class="OraCellText"><rw:field id="FFOTOCASA214" src="FOTOCASA" nullValue="&nbsp;"> F_FOTOCASA </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFCountNUMSEGSOCIALPerCODIGO214" src="HBNUMSEGSOCIAL214"/> class="OraTotalNumber">Recuento: <rw:field id="FCountNUMSEGSOCIALPerCODIGO214" src="CountNUMSEGSOCIALPerCODIGO" nullValue="&nbsp;"> F_CountNUMSEGSOCIALPerCODIGO </rw:field></td>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
     ...
     <tr>
      <td  class="OraTotalNumber">Codigo <rw:field id="FCODIGO214" src="CODIGO" nullValue="&nbsp;"> F_CODIGO </rw:field></td>
     </tr>
    </table>
   </td>
  </tr>
...
<table class="OraTable" summary="Pacientes en hospital">
 <tr>
  <th class="OraTotalNumber"> Recuento: <rw:field id="F_CountNUMSEGSOCIALPerReport" src="CountNUMSEGSOCIALPerReport" nullValue="&nbsp;"> F_CountNUMSEGSOCIALPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGCODIGOGRPFR214" -->
