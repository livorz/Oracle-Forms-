...
<report name="DEPARTAMENTOEMPLEADOS" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT DNAME, FNAME, LNAME, SALARY
FROM DEPARTMENT, EMPLOYEE
WHERE DEPARTMENT.DNUMBER = EMPLOYEE.DNO]]>
      </select>
      <displayInfo x="1.65002" y="1.00000" width="0.69995" height="0.19995"/>
      <group name="G_DNAME">
        <displayInfo x="1.04773" y="1.94995" width="1.90466" height="0.61963"
        />
        <dataItem name="DNAME" datatype="vchar2" columnOrder="11" width="15"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nombre departamento">
          <dataDescriptor expression="DNAME" descriptiveExpression="DNAME"
           order="1" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="AvgSALARYPerDNAME" source="SALARY" function="average"
         width="22" precision="7" reset="G_DNAME" compute="report"
      ...
      <group name="G_FNAME">
        <displayInfo x="1.45007" y="3.31958" width="1.09998" height="0.79956"
        />
        <dataItem name="FNAME" datatype="vchar2" columnOrder="12" width="15"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Nombre empleado">
          <dataDescriptor expression="FNAME" descriptiveExpression="FNAME"
           order="2" width="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LNAME" datatype="vchar2" columnOrder="13" width="15"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
  ...
  <section name="main">
    <body>
      <frame name="M_G_DNAME_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="4.37500" height="0.93750"
        />
         ...
         printDirection="down" minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_FNAME_GRPFR">
            ...
            <repeatingFrame name="R_G_FNAME" source="G_FNAME"
             printDirection="down" minWidowRecords="1" columnMode="no">
              <geometryInfo x="0.00000" y="0.37500" width="4.37500"
               height="0.18750"/>
              <generalLayout verticalElasticity="expand"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="TableCell"/>
              ...
              <field name="F_SALARY" source="SALARY" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="3.00000" y="0.37500" width="1.37500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_FNAME_FTR">
              <geometryInfo x="0.00000" y="0.56250" width="4.37500"
               height="0.18750"/>
              <advancedLayout printObjectOnPage="lastPage"
               basePrintingOn="anchoringObject"/>
              <visualSettings fillPattern="transparent"
               fillBackgroundColor="Totals"/>
              <field name="F_AvgSALARYPerDNAME" source="AvgSALARYPerDNAME"
               minWidowLines="1" spacing="0" alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="3.00000" y="0.56250" width="1.37500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            ...
            <frame name="M_G_FNAME_HDR">
              ...
              <text name="B_SALARY" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="3.00000" y="0.18750" width="1.37500"
                 height="0.18750"/>
          ...
          <text name="B_DNAME" minWidowLines="1">
            ...
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
               textColor="TextColor"/>
              <string>
              <![CDATA[Nombre departamento]]>
              </string>
            </textSegment>
          </text>
        </repeatingFrame>
        <frame name="M_G_DNAME_FTR">
          <geometryInfo x="0.00000" y="0.75000" width="4.37500"
           height="0.18750"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
          ...
          <field name="F_AvgSALARYPerReport" source="AvgSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="0.50000" y="0.75000" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
    ...
    <margin>
      <image name="B_1_SEC2" templateSection="main">
        <geometryInfo x="0.50000" y="0.50000" width="1.40625" height="0.37500"
        />
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="2.33276" y="0.62500" width="2.08435" height="0.16675"
        />
        <textSegment>
          <font face="Arial" size="10"/>
          <string>
          <![CDATA[Departamentos y empleados]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <reportPrivate defaultReportType="masterDetail" versionFlags2="0"
   templateName="rwblue" sectionTitle="Departamentos y empleados"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGDNAMEGRPFR137">
<rw:foreach id="RGDNAME1371" src="G_DNAME">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader"> Departamentos y empleados <br>Nombre departamento <rw:field id="F_DNAME" src="DNAME" breakLevel="RGDNAME1371" breakValue="&nbsp;"> F_DNAME </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    <td valign="top">
    <table class="OraTable" summary="Departamentos y empleados">
     <!-- Header -->
     <thead>
      <tr>
       <th <rw:id id="HBFNAME137" asArray="no"/> class="OraColumnHeader"> Nombre empleado </th>
       <th <rw:id id="HBLNAME137" asArray="no"/> class="OraColumnHeader"> Apellido </th>
       <th <rw:id id="HBSALARY137" asArray="no"/> class="OraColumnHeader"> Salario </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGFNAME1371" src="G_FNAME">
       <tr>
        ...
        <td <rw:headers id="HFSALARY137" src="HBSALARY137"/> class="OraCellNumber"><rw:field id="FSALARY137" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFAvgSALARYPerDNAME137" src="HBSALARY137"/> class="OraTotalNumber">Media: <rw:field id="FAvgSALARYPerDNAME137" src="AvgSALARYPerDNAME" nullValue="&nbsp;"> F_AvgSALARYPerDNAME </rw:field></td>
     </tr>
     <tr>
      <td  class="OraTotalNumber">Nombre departamento <rw:field id="FDNAME137" src="DNAME" nullValue="&nbsp;"> F_DNAME </rw:field></td>
     </tr>
    </table>
   </td>
  </tr>
...
<table class="OraTable" summary="Departamentos y empleados">
 <tr>
  <th class="OraTotalNumber"> Media: <rw:field id="F_AvgSALARYPerReport" src="AvgSALARYPerReport" nullValue="&nbsp;"> F_AvgSALARYPerReport </rw:field></th>
 </tr>
</table>
</rw:dataArea> <!-- id="MGDNAMEGRPFR137" -->
